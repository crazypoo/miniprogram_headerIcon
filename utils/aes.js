...
!function() {
    ...
    for (var _ = 0, g = 0, y = 0; 256 > y; y++) {
        ...
        n[_] = v, s[v] = _;
        var B = l[_], m = l[B], x = l[m], k = 257 * l[v] ^ 16843008 * v;
        o[_] = k << 24 | k >>> 8, c[_] = k << 16 | k >>> 16, a[_] = k << 8 | k >>> 24, f[_] = k, 
        k = 16843009 * x ^ 65537 * m ^ 257 * B ^ 16843008 * _, h[v] = k << 24 | k >>> 8, 
        u[v] = k << 16 | k >>> 16, p[v] = k << 8 | k >>> 24, d[v] = k, _ ? (_ = B ^ l[l[l[x ^ B]]], 
        g ^= l[l[g]]) : _ = g = 1;
    }
    var S = [ 0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54 ], i = i.AES = r.extend({
        ...
        _doCryptBlock: function(t, e, r, i, n, s, o, c) {
            for (var a = this._nRounds, f = t[e] ^ r[0], h = t[e + 1] ^ r[1], u = t[e + 2] ^ r[2], p = t[e + 3] ^ r[3], d = 4, l = 1; l < a; l++) var y = i[f >>> 24] ^ n[h >>> 16 & 255] ^ s[u >>> 8 & 255] ^ o[255 & p] ^ r[d++], _ = i[h >>> 24] ^ n[u >>> 16 & 255] ^ s[p >>> 8 & 255] ^ o[255 & f] ^ r[d++], g = i[u >>> 24] ^ n[p >>> 16 & 255] ^ s[f >>> 8 & 255] ^ o[255 & h] ^ r[d++], p = i[p >>> 24] ^ n[f >>> 16 & 255] ^ s[h >>> 8 & 255] ^ o[255 & u] ^ r[d++], f = y, h = _, u = g;
...
var e = t.enc.Utf8.parse("hebangnet1239870"), r = t.enc.Utf8.parse("1239870hebangnet");

module.exports.Decrypt = function(i) {
    return t.AES.decrypt(i, e, {
        iv: r,
        mode: t.mode.CBC,
        padding: t.pad.Pkcs7
    }).toString(t.enc.Utf8).toString();
}, module.exports.Encrypt = function(i) {
    var n = t.enc.Utf8.parse(i);
    return t.AES.encrypt(n, e, {
        iv: r,
        mode: t.mode.CBC,
        padding: t.pad.Pkcs7
